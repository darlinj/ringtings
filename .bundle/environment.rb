...
module Bundler
  ...
  AUTOREQUIRES = {:test=>[["factory_girl", false], ["relevance-rcov", false], ["webrat", false], ["shoulda", false], ["roodi", false], ["celerity", false], ["rspec", false], ["culerity", false], ["rspec-rails", false], ["cucumber", false]], :default=>[["clearance", false], ["bundler", false], ["capistrano-ext", false], ["javan-whenever", false], ["whenever", false], ["ahamid-postgres-pr", false], ["nokogiri", false], ["curb", false], ["paperclip", false], ["capistrano", false], ["rails", false]]}
  SPECS        = [
