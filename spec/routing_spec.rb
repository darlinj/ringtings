...
describe 'Routing' do
  ...
  it { should route(:get,   "/voicemail/foo"                               ).to(:controller => 'voicemail', :action => 'show', :id => 'foo') }
  it { should route(:delete,"/voicemail/foo"                               ).to(:controller => 'voicemail', :action => 'destroy', :id => 'foo') }
