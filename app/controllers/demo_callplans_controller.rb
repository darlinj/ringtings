...
#  end
  ...
  def create_ivr_menu_options target_phone_number, inbound_phone_number, company_name
    ivr_menu_1 = IvrMenuEntry.create! :action => 'menu-exit', :digits => "*", :system_param_part => nil, :user_param_part => nil, :prompt => "Exit the menu"
    ivr_menu_2 = IvrMenuEntry.create! :action => 'menu-exec-app', :digits => "1", :system_param_part => "transfer", :user_param_part => "#{target_phone_number} XML default", :prompt => "Transfer call to:"
    ivr_menu_3 = IvrMenuEntry.create! :action => 'menu-exec-app', :digits => "2", :system_param_part => "voicemail default ${domain_name} ${dialed_extension}", :user_param_part => nil, :prompt => "Transfer to voicemail:"
    ivr_menu_4 = IvrMenuEntry.create! :action => 'menu-exec-app', :digits => "3", :system_param_part => "playback", :user_param_part => "ivr/suckingteeth.wav", :prompt => "Play an audio file:"
    ivr_menu_5 = IvrMenuEntry.create! :action => 'menu-exec-app', :digits => "4", :system_param_part => "playback", :user_param_part => "ivr/suckingteeth.wav", :prompt => "Play an audio file:"
    ivr_menu_6 = IvrMenuEntry.create! :action => 'menu-exec-app', :digits => "5", :system_param_part => "playback", :user_param_part => "ivr/suckingteeth.wav", :prompt => "Play an audio file:"
